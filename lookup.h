...
class Lookup {
 ...
 public:
  ...
  /* int getLocY2(std::shared_ptr<agent> &a) {
    // return int(a->y / (sizeY / breakupY));
  }

  int getLocX2(std::shared_ptr<agent> &a) {
    // return int(a->x / (sizeX / breakupX));
  }
  */
  //}
	...
	//	int y_search2 = getLocY2(base_agent);
	//	int x_search2 = getLocX2(base_agent);
	//	base_agent2->input_agent2[0]=nullptr;
